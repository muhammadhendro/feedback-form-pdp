...
const helperTextClassName = 'text-sm leading-6 text-[#667085]';
    ...
    <div className="w-full">
        ...
        <div className="relative">
            <select
                ...
                onFocus={onFocus}
                onBlur={onBlur}
                className={`${fieldClassName} cursor-pointer appearance-none pr-12`}
                required={required}
            >
            ...
            <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-[#7D8694]">
...
const SectionHeader = ({ title, description }) => (
    <div className="flex items-start gap-4">
        ...
        <div>
            ...
            {description ? <p className={helperTextClassName}>{description}</p> : null}
        </div>
    </div>
);
    ...
    const validateForm = () => {
        ...
        requiredOptions.forEach((optionName) => {
            if (!formData[optionName]) {
                errors[optionName] = 'Silakan pilih jawaban terlebih dahulu';
            }
        });

        ['yt_kebutuhan_layanan', 'yt_bersedia_info', 'yt_bersedia_dokumentasi'].forEach((optionName) => {
            if (!formData[optionName]) {
                errors[optionName] = 'Silakan pilih Ya atau Tidak';
            }
        });
                ...
                <div ref={wrapperRef} className="mx-auto max-w-4xl">
                    <div className="relative overflow-hidden rounded-[28px] border border-[#E4E7EC] bg-white px-6 py-10 text-center shadow-[0_24px_80px_rgba(32,36,47,0.08)] md:px-12 md:py-14">
                        ...
                        <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#667085] md:text-lg">
                            Feedback Anda sudah berhasil dikirim dan tercatat dengan baik.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div ref={wrapperRef} className="mx-auto max-w-5xl">
                <div className="relative overflow-hidden rounded-[28px] border border-[#E4E7EC] bg-white px-4 pb-6 pt-5 shadow-[0_24px_80px_rgba(32,36,47,0.08)] sm:px-6 md:px-12 md:pb-12 md:pt-8">
                    ...
                    <div className="relative border-b border-[#EAECF0] pb-8">
                        ...
                        <h1 className="mt-3 text-[2rem] font-bold tracking-[-0.03em] text-[#20242F] md:text-[2.7rem]">
                            Feedback Form
                        </h1>
                        <p className="mt-3 max-w-3xl text-sm leading-7 text-[#667085] md:text-base">
                            Silakan isi formulir berikut untuk membantu kami mengevaluasi kualitas training dan
                            pengalaman Anda selama sesi berlangsung.
                        </p>
                    ...
                    <form onSubmit={handleSubmit} className="relative mt-8 space-y-10">
                        <section className="space-y-6">
                            <SectionHeader
                                title="Data Peserta"
                                description="Isi data singkat Anda terlebih dahulu sebelum melanjutkan ke bagian evaluasi."
                            />
                        ...
                        <section className="space-y-6 border-t border-[#EAECF0] pt-10">
                            <SectionHeader
                                title="Training Feedback"
                                description="Pilih jawaban yang paling menggambarkan pengalaman Anda selama training."
                            />
                        ...
                        <section className="space-y-6 border-t border-[#EAECF0] pt-10">
                            <SectionHeader
                                title="Persetujuan dan Minat Lanjutan"
                                description="Bagian ini membantu tim menindaklanjuti kebutuhan Anda setelah training."
                            />
                        ...
                        <section className="space-y-6 border-t border-[#EAECF0] pt-10">
                            <SectionHeader
                                title="Komentar Tambahan"
                                description="Masukan Anda akan membantu kami meningkatkan kualitas sesi berikutnya."
                            />
                            ...
                            <div className="space-y-6">
                                <div className="space-y-3">
                                    <label
                                        className={`block text-sm font-semibold transition-colors duration-200 ${
                                            focusedField === 'ur_kritik_saran' ? 'text-[#90C343]' : 'text-[#20242F]'
                                        }`}
                                    >
                                ...
                                <div className="space-y-3">
                                    <label
                                        className={`block text-sm font-semibold transition-colors duration-200 ${
                                            focusedField === 'ur_hal_baik' ? 'text-[#90C343]' : 'text-[#20242F]'
                                        }`}
                                    >
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        className={textareaClassName}
                                        placeholder="Tuliskan hal yang paling berkesan menurut Anda..."
                                    />
                                </div>
                                ...
                                <div className="space-y-3">
                                    <label
                                        className={`block text-sm font-semibold transition-colors duration-200 ${
                                            focusedField === 'ur_saran_selanjutnya' ? 'text-[#90C343]' : 'text-[#20242F]'
                                        }`}
                                    >
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        className={textareaClassName}
                                        placeholder="Saran Anda sangat membantu kami..."
                                    />
                                </div>
                                ...
                                <div className="space-y-3">
                                    <label
                                        className={`block text-sm font-semibold transition-colors duration-200 ${
                                            focusedField === 'ur_kebutuhan_topik' ? 'text-[#90C343]' : 'text-[#20242F]'
                                        }`}
                                    >
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        className={textareaClassName}
                                        placeholder="Contoh: topik, studi kasus, atau format sesi yang diinginkan..."
                                    />
                                </div>
                            </div>
                        </section>
